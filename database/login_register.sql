...
CREATE TABLE `booking_history` (
  ...
  `status` varchar(50) NOT NULL DEFAULT 'Pending',  -- Example status, can be 'Pending', 'Confirmed', 'Cancelled', etc.
...
--
-- Inserting sample booking data
--

INSERT INTO `booking_history` (`booking_id`, `user_id`, `booking_date`, `product_id`, `quantity`, `total_price`, `status`) 
VALUES
(1, 1, '2024-11-17 08:00:00', 1, 2, 40.00, 'Confirmed'),
(2, 1, '2024-11-17 08:15:00', 2, 1, 39.98, 'Pending');
